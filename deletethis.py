...
def move_snake():
    ...
    if new_xpos >= right_edge:
        ...
        turtle.write("you hit the right edge , GAME OVER!", font=("Arial", 25, "normal") , align="center")
    elif new_xpos <= left_edge:
        #print('you hit the left edge , GAME OVER!')
        turtle.write("you hit the left edge , GAME OVER!", font=("Arial", 25, "normal") , align="center")
    elif new_ypos >= up_edge:
        #print('you hit the up edge, GAME OVER!')
        turtle.write("you hit the upper edge , GAME OVER!", font=("Arial", 25, "normal") , align="center")
    elif new_ypos <= down_edge:
        #print('you hit the down edge , GAME OVER!')
        turtle.write("you hit the bottom edge , GAME OVER!", font=("Arial", 25, "normal") , align="center")

    if pos_list[-1] in pos_list[0:-1]:
        #print("You ate yourself") 
        turtle.write("game over , you ate yourself", font=("Arial", 25, "normal") , align="center")
